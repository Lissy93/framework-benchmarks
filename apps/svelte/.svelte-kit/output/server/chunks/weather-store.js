...
class WeatherService {
  ...
  async getMockData() {
    try {
      ...
      console.error("Error loading mock data:", error2);
      throw error2;
    }
  }
  async geocodeLocation(cityName) {
    ...
    try {
      ...
      console.error("Geocoding error:", error2);
  ...
  async getWeatherData(latitude, longitude) {
    ...
    try {
      ...
      console.error("Weather API error:", error2);
  ...
  async getWeatherByCity(cityName) {
    try {
      ...
      console.error("Weather service error:", error2);
      throw error2;
    }
  }
